...
namespace PokemonPocket
{
    public class PokemonMaster
    {
        ...
        public Skill? ArenaTempSkillGain(string skillName)
        {
            ...
            {
                "absorb" => new Absorb(Id!),
                "acid" => new Acid(Id!),
                "acid armor" => new AcidArmor(Id!),
                "agility" => new Agility(Id!),
                "amnesia" => new Amnesia(Id!),
                "aurora beam" => new AuroraBeam(Id!),
                "barrage" => new Barrage(Id!),
                "barrier" => new Models.Barrier(Id!),
                "bide" => new Bide(Id!),
                "bind" => new Bind(Id!),
                "bite" => new Bite(Id!),
                "blizzard" => new Blizzard(Id!),
                "body slam" => new BodySlam(Id!),
                "bone club" => new BoneClub(Id!),
                "bonemerang" => new Bonemerang(Id!),
                "bubble" => new Bubble(Id!),
                "bubble beam" => new BubbleBeam(Id!),
                "clamp" => new Clamp(Id!),
                "comet punch" => new CometPunch(Id!),
                "confuse ray" => new ConfuseRay(Id!),
                "confusion" => new Confusion(Id!),
                "constrict" => new Constrict(Id!),
                "conversion" => new Conversion(Id!),
                "counter" => new Counter(Id!),
                "crabhammer" => new Crabhammer(Id!),
                "cut" => new Cut(Id!),
                "defense curl" => new DefenseCurl(Id!),
                "dig" => new Dig(Id!),
                "disable" => new Disable(Id!),
                "dizzy punch" => new DizzyPunch(Id!),
                "double-edge" => new DoubleEdge(Id!),
                "double kick" => new DoubleKick(Id!),
                "double slap" => new DoubleSlap(Id!),
                "double team" => new DoubleTeam(Id!),
                "dragon rage" => new DragonRage(Id!),
                "dream eater" => new DreamEater(Id!),
                "drill peck" => new DrillPeck(Id!),
                "earthquake" => new Earthquake(Id!),
                "egg bomb" => new EggBomb(Id!),
                "ember" => new Ember(Id!),
                "explosion" => new Explosion(Id!),
                "fire blast" => new FireBlast(Id!),
                "fire punch" => new FirePunch(Id!),
                "fire spin" => new FireSpin(Id!),
                "fissure" => new Fissure(Id!),
                "flamethrower" => new Flamethrower(Id!),
                "flash" => new Flash(Id!),
                "fly" => new Fly(Id!),
                "focus energy" => new FocusEnergy(Id!),
                "fury attack" => new FuryAttack(Id!),
                "fury swipes" => new FurySwipes(Id!),
                "glare" => new Glare(Id!),
                "growl" => new Growl(Id!),
                "growth" => new Growth(Id!),
                "guillotine" => new Guillotine(Id!),
                "gust" => new Gust(Id!),
                "harden" => new Harden(Id!),
                "haze" => new Haze(Id!),
                "headbutt" => new Headbutt(Id!),
                "high jump kick" => new HighJumpKick(Id!),
                "horn attack" => new HornAttack(Id!),
                "horn drill" => new HornDrill(Id!),
                "hydro pump" => new HydroPump(Id!),
                "hyper beam" => new HyperBeam(Id!),
                "hyper fang" => new HyperFang(Id!),
                "hypnosis" => new Hypnosis(Id!),
                "ice beam" => new IceBeam(Id!),
                "ice punch" => new IcePunch(Id!),
                "jump kick" => new JumpKick(Id!),
                "karate chop" => new KarateChop(Id!),
                "kinesis" => new Kinesis(Id!),
                "leech life" => new LeechLife(Id!),
                "leech seed" => new LeechSeed(Id!),
                "leer" => new Leer(Id!),
                "lick" => new Lick(Id!),
                "light screen" => new LightScreen(Id!),
                "lovely kiss" => new LovelyKiss(Id!),
                "low kick" => new LowKick(Id!),
                "meditate" => new Meditate(Id!),
                "mega drain" => new MegaDrain(Id!),
                "mega kick" => new MegaKick(Id!),
                "mega punch" => new MegaPunch(Id!),
                "metronome" => new Metronome(Id!),
                "mimic" => new Mimic(Id!),
                "minimize" => new Minimize(Id!),
                "mirror move" => new MirrorMove(Id!),
                "mist" => new Mist(Id!),
                "night shade" => new NightShade(Id!),
                "pay day" => new PayDay(Id!),
                "peck" => new Peck(Id!),
                "petal dance" => new PetalDance(Id!),
                "pin missile" => new PinMissile(Id!),
                "poison gas" => new PoisonGas(Id!),
                "poison powder" => new PoisonPowder(Id!),
                "poison sting" => new PoisonSting(Id!),
                "pound" => new Pound(Id!),
                "psybeam" => new Psybeam(Id!),
                "psychic" => new Psychic(Id!),
                "psywave" => new Psywave(Id!),
                "quick attack" => new QuickAttack(Id!),
                "rage" => new Rage(Id!),
                "razor leaf" => new RazorLeaf(Id!),
                "razor wind" => new RazorWind(Id!),
                "recover" => new Recover(Id!),
                "reflect" => new Reflect(Id!),
                "rest" => new Rest(Id!),
                "roar" => new Roar(Id!),
                "rock slide" => new RockSlide(Id!),
                "rock throw" => new RockThrow(Id!),
                "rolling kick" => new RollingKick(Id!),
                "sand attack" => new SandAttack(Id!),
                "scratch" => new Scratch(Id!),
                "screech" => new Screech(Id!),
                "seismic toss" => new SeismicToss(Id!),
                "self-destruct" => new SelfDestruct(Id!),
                "sharpen" => new Sharpen(Id!),
                "sing" => new Sing(Id!),
                "skull bash" => new SkullBash(Id!),
                "sky attack" => new SkyAttack(Id!),
                "slam" => new Slam(Id!),
                "slash" => new Slash(Id!),
                "sleep powder" => new SleepPowder(Id!),
                "sludge" => new Sludge(Id!),
                "smog" => new Smog(Id!),
                "smokescreen" => new Smokescreen(Id!),
                "soft-boiled" => new SoftBoiled(Id!),
                "solar beam" => new SolarBeam(Id!),
                "sonic boom" => new SonicBoom(Id!),
                "spike cannon" => new SpikeCannon(Id!),
                "splash" => new Splash(Id!),
                "spore" => new Spore(Id!),
                "stomp" => new Stomp(Id!),
                "strength" => new Strength(Id!),
                "string shot" => new StringShot(Id!),
                "struggle" => new Struggle(Id!),
                "stun spore" => new StunSpore(Id!),
                "submission" => new Submission(Id!),
                "substitute" => new Substitute(Id!),
                "super fang" => new SuperFang(Id!),
                "supersonic" => new Supersonic(Id!),
                "surf" => new Surf(Id!),
                "swift" => new Swift(Id!),
                "swords dance" => new SwordsDance(Id!),
                "tackle" => new Tackle(Id!),
                "tail whip" => new TailWhip(Id!),
                "take down" => new TakeDown(Id!),
                "teleport" => new Teleport(Id!),
                "thrash" => new Thrash(Id!),
                "thunder" => new Thunder(Id!),
                "thunderbolt" => new Thunderbolt(Id!),
                "thunder punch" => new ThunderPunch(Id!),
                "thunder shock" => new ThunderShock(Id!),
                "thunder wave" => new ThunderWave(Id!),
                "toxic" => new Toxic(Id!),
                "transform" => new Transform(Id!),
                "tri attack" => new TriAttack(Id!),
                "twineedle" => new Twineedle(Id!),
                "vine whip" => new VineWhip(Id!),
                "vise grip" => new ViseGrip(Id!),
                "waterfall" => new Waterfall(Id!),
                "water gun" => new WaterGun(Id!),
                "whirlwind" => new Whirlwind(Id!),
                "wing attack" => new WingAttack(Id!),
