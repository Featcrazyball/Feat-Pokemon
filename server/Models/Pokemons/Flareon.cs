...
public class Flareon : PokemonMaster
{
    ...
    public Flareon(float HP, string nickname, string ownerId, int exp)
    : base("Flareon", "Fire", HP, 130, 60, 95, 110, 65, ownerId, 20, "Flash Fire")
    {
        Nickname = nickname;
        Experience = exp;
        SkillPool = "Tackle, Sand Attack, Quick Attack, Leer, Ember, Fire Spin, Smog, Flamethrower, Toxic, Body Slam, Take Down, Double-Edge, Rage, Mimic, Double Team, Reflect, Bide, Fire Blast, Swift, Rest, Substitute";
    ...
    : base("Flareon", "Fire", 100, 130, 60, 95, 110, 65, eevee.OwnerId?? "Unknown", 20, "Flash Fire")
    {
        Id = eevee.Id;
        Level = 1;
