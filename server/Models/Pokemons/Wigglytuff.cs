...
{
    public override float HealthOverride {get;set;} = 140;
    ...
    public Wigglytuff(float HP, string nickname, string ownerId, int exp)
    : base("Wigglytuff", "Normal/Fairy", HP, 70, 45, 85, 50, 45, ownerId, 30, "Cute Charm")
    {
        Nickname = nickname;
        Experience = exp;
        SkillPool = "Sing, Disable, Defense Curl, Double Slap, Rest, Body Slam, Take Down, Double-Edge, Hyper Beam, Seismic Toss, Thunderbolt, Thunder, Psychic, Mimic, Double Team, Reflect, Bide, Rest, Substitute";
    ...
    : base("Wigglytuff", "Normal/Fairy", 100, 70, 45, 85, 50, 45, jigglypuff.OwnerId ?? "Unknown", 30, "Cute Charm")
    {
        Id = jigglypuff.Id;
        Level = 1;
    ...
    public Wigglytuff(string ownerId)
    : base("Wigglytuff", "Normal/Fairy", 100, 70, 45, 85, 50, 45, ownerId, 30, "Cute Charm")
    {
        Nickname = "None";
        Experience = 0;
        SkillPool = "Sing, Disable, Defense Curl, Double Slap, Rest, Body Slam, Take Down, Double-Edge, Hyper Beam, Seismic Toss, Thunderbolt, Thunder, Psychic, Mimic, Double Team, Reflect, Bide, Rest, Substitute";
