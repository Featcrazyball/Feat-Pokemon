...
public class Beedrill : PokemonMaster
{
    ...
    public Beedrill(float HP, string nickname, string ownerId, int exp)
    : base("Beedrill", "Bug/Poison", HP, 90, 40, 45, 80, 75, ownerId, 20, "Swarm")
    {
        Nickname = nickname;
        Experience = exp;
        SkillPool = "Fury Attack, Focus Energy, Twinneedle, Rage, Agility, Toxic, Take Down, Double-Edge, Hyper Beam, Mimic, Skull Bash, Rest, Substitute";
    ...
    : base("Beedrill", "Bug/Poison", 100, 90, 40, 45, 80, 75, kakuna.OwnerId ?? "Unknown", 20, "Swarm")
    {
        Id = kakuna.Id;
        Level = 1;
